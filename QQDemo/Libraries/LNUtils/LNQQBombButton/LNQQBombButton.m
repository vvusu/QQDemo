...
- (NSMutableArray *)images {
    if (_images == nil) {
        ...
        for (int i = 1; i < 6; i++) {
            UIImage *image = [UIImage imageNamed:[@"LNQQBombButton.bundle" stringByAppendingPathComponent:[NSString stringWithFormat:@"unreadBomb_%d", i]]];
